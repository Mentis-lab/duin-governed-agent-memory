...
function activeWindow(): BrowserWindow | null {
  ...
  // Same hazard as tray.ts: the hotkeys are registered globally for the app's whole lifetime, so
  // they outlive the window. A destroyed BrowserWindow stays truthy and throws on every method,
  // which would take out the handler before it could do anything useful.
