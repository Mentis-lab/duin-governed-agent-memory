...
export function registerBrowserHandlers(): void {
  ipcMain.handle('browser:newTab', async (_e, args: { url?: string }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'newTab failed') }
    }
  })
  ...
  ipcMain.handle('browser:closeTab', async (_e, args: { id: string }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'closeTab failed') }
    }
  })
  ...
  ipcMain.handle('browser:setActiveTab', async (_e, args: { id: string }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'setActiveTab failed') }
    }
  })
  ...
  ipcMain.handle('browser:navigate', async (_e, args: { id: string; url: string }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'navigate failed') }
    }
  })
  ...
  ipcMain.handle('browser:back', async (_e, args: { id: string }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'back failed') }
    }
  })
  ...
  ipcMain.handle('browser:forward', async (_e, args: { id: string }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'forward failed') }
    }
  })
  ...
  ipcMain.handle('browser:reload', async (_e, args: { id: string }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'reload failed') }
    }
  })
  ...
  ipcMain.handle(
    ...
    async (_e, args: { x: number; y: number; width: number; height: number }) => {
      try {
        ...
        return { success: false, error: friendly(err, 'setBounds failed') }
      }
    }
  )
  ...
  ipcMain.handle('browser:setVisible', async (_e, args: { visible: boolean }) => {
    try {
      ...
      return { success: false, error: friendly(err, 'setVisible failed') }
    }
  })
  ...
  ipcMain.handle('browser:listTabs', async () => {
    try {
      ...
      return { success: false, error: friendly(err, 'listTabs failed') }
    }
  })
}
