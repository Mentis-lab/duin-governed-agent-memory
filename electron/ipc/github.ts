...
import {
  readSettingsFile as readSettingsJson,
  writeSettingsFile as writeSettingsJson
} from '../services/settings-file'
...
function readSettingsFile(): Record<string, unknown> {
  return readSettingsJson(getSettingsPath()).data
}

function writeSettingsFile(next: Record<string, unknown>): void {
  writeSettingsJson(getSettingsPath(), next)
}
...
function emitTokenRejected(): void {
  ...
  for (const win of BrowserWindow.getAllWindows()) {
    ...
    } catch (e) { console.debug('[github] window closed:', messageOf(e)) }
  }
}
...
export function registerGitHubHandlers(): void {
  ...
  ipcMain.handle('github:saveOAuthClient', async (_e, args: { clientId: string; clientSecret: string }) => {
    try {
      ...
      return failure(friendly(err, 'Failed to save OAuth client'))
    }
  })
  ...
  ipcMain.handle('github:hasOAuthClient', async () => {
    try {
      ...
      return failure(friendly(err, 'Probe failed'))
    }
  })
  ...
  ipcMain.handle('github:setMode', async (_e, mode: GitHubAuthMode) => {
    try {
      ...
      return failure(friendly(err, 'Failed to set mode'))
    }
  })
  ...
  ipcMain.handle('github:status', async () => {
    try {
      ...
      return failure(friendly(err, 'Status probe failed'))
    }
  })
  ...
  ipcMain.handle('github:connect', async () => {
    try {
      ...
      return failure(friendly(err, 'GitHub connect failed'))
    }
  })
  ...
  ipcMain.handle('github:disconnect', async () => {
    try {
      ...
      return failure(friendly(err, 'Disconnect failed'))
    }
  })
  ...
  ipcMain.handle('github:viewer', async () => {
    try {
      ...
      return failure(friendly(err, 'Viewer fetch failed'))
    }
  })
  ...
  ipcMain.handle('github:repositories', async (_e, args?: { page?: number; perPage?: number }) => {
    try {
      ...
      return failure(friendly(err, 'List repositories failed'))
    }
  })
  ...
  ipcMain.handle('github:getRepository', async (_e, args: { owner: string; repo: string }) => {
    try {
      ...
      return failure(friendly(err, 'Get repository failed'))
    }
  })
  ...
  ipcMain.handle('github:pickCloneDir', async () => {
    try {
      ...
      return failure(friendly(err, 'Could not open folder picker'))
    }
  })
  ...
  ipcMain.handle('github:clone', async (_e, args: { owner: string; repo: string; targetDir: string }) => {
    try {
      ...
      return failure(friendly(err, 'Clone failed'))
    }
  })
  ...
  ipcMain.handle(
    ...
    async (_e, args: { baseDir: string; repoName: string }) => {
      try {
        ...
        return failure(friendly(err, 'Resolve failed'))
      }
    }
  )
  ...
  ipcMain.handle('github:getProjectRepo', async (_e, args: { projectId: string }) => {
    try {
      ...
      return failure(friendly(err, 'Lookup failed'))
    }
  })
  ...
  ipcMain.handle(
    ...
    async (_e, args: { projectId: string; owner: string; repo: string; localPath?: string | null }) => {
      try {
        ...
        return failure(friendly(err, 'Assign failed'))
      }
    }
  )
  ...
  ipcMain.handle('github:unlinkRepo', async (_e, args: { projectId: string }) => {
    try {
      ...
      return failure(friendly(err, 'Unlink failed'))
    }
  })
  ...
  ipcMain.handle(
    ...
    async (_e, args: { owner: string; repo: string; base: string; head: string }) => {
      try {
        ...
        return failure(friendly(err, 'Compare failed'))
      }
    }
  )
      ...
      try {
        ...
        if (args.conversationId) {
          try {
            ...
            console.warn('[github] failed to link PR to conversation:', messageOf(linkErr))
          }
        }
        return envelope(pr)
      } catch (err) {
        return failure(friendly(err, 'PR creation failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        return failure(friendly(err, 'List PRs failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: { owner: string; repo: string; number: number }) => {
      try {
        ...
        return failure(friendly(err, 'Get PR failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: { conversationId: string }) => {
      try {
        ...
        return failure(friendly(err, 'List conversation PRs failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: { owner: string; repo: string; number: number }) => {
      try {
        ...
        return failure(friendly(err, 'List review comments failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: { owner: string; repo: string; number: number }) => {
      try {
        ...
        return failure(friendly(err, 'List review threads failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: github.CreatePullRequestReviewInput) => {
      try {
        ...
        return failure(friendly(err, 'Create review failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: github.ReplyToReviewCommentInput) => {
      try {
        ...
        return failure(friendly(err, 'Reply to review comment failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: { threadId: string }) => {
      try {
        ...
        return failure(friendly(err, 'Resolve review thread failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: { threadId: string }) => {
      try {
        ...
        return failure(friendly(err, 'Unresolve review thread failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        return failure(friendly(err, 'List issues failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (_e, args: { owner: string; repo: string; number: number }) => {
      try {
        ...
        return failure(friendly(err, 'Get PR status failed'))
      }
    }
  )
  ...
  ipcMain.handle(
    ...
    async (
      ...
      try {
        ...
        return failure(friendly(err, 'Push failed'))
      }
    }
  )
  ...
  ipcMain.handle('github:openInBrowser', async (_e, url: string) => {
    try {
      ...
      return failure(friendly(err, 'Open in browser failed'))
    }
  })
}
