// Renderer-side view types + row builder for the task-graph panel. Pure — no
// IPC, no React — so it is unit-testable in isolation.
...
/** Flatten the conversation subgraph into an indented, fork-depth-ordered list.
 *  Only conversation nodes are rows; depth is the number of fork-parent hops. */
