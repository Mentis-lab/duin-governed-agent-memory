      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1.5">
            ...
            <span className="shrink-0 rounded px-1 py-0.5 font-mono text-[11px] uppercase text-[var(--text-muted)]">
        ...
        <span className={`shrink-0 rounded-full px-1.5 py-0.5 font-mono text-[11px] uppercase ${STATUS_CLASS[node.status]}`}>
          {node.status}
        </span>
        {node.canAbort && (
          <button
