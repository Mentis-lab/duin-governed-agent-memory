  ...
  return (
    <div className="rounded border border-[var(--panel-border)] bg-[var(--bg-primary)] p-2">
      <div className="mb-2 flex items-center justify-between">
        ...
        <span className="text-[11px] text-[var(--text-muted)]">create ready-to-edit hooks</span>
      </div>
        ...
        {HOOK_TEMPLATES.map((template) => {
          ...
          return (
            ...
            >
              ...
              <span className="mt-1 block text-[11px] uppercase tracking-wider text-[var(--accent)]">
