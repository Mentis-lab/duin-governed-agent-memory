    ...
    >
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-24 rounded border border-[var(--border)] bg-[var(--bg-secondary)] px-2 py-1 font-mono text-[12px] text-[var(--text-primary)] focus:border-[var(--accent)] focus:outline-none"
        />
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="space-y-3">
        ...
        <NumberRow
          id="streamInactivity"
          label={t('SSE inactivity watchdog')}
