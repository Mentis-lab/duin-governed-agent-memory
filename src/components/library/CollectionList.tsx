            ...
            <div className="flex items-center justify-between gap-1">
              {isRenaming ? (
                <input
                  ...
                  className="flex-1 rounded border border-[var(--panel-border)] bg-[var(--bg-primary)] px-1 text-[11px] text-[var(--text-primary)]"
                />
              ) : (
                <button
                  ...
                  className="flex-1 truncate text-left text-[12px] text-[var(--text-primary)]"
                  title={c.name}
                >
                  {c.name}
                </button>
