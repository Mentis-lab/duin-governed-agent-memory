    ...
    >
      ...
      >
        <input
          ...
          onKeyDown={handleKey}
          placeholder={t('Jump to chapter…')}
          className="w-full rounded-t-md bg-transparent px-3 py-2 text-[12px] text-[var(--text-primary)] outline-none"
        />
        <div className="max-h-[280px] overflow-y-auto border-t border-[var(--panel-border)]">
          {ranked.length === 0 && (
            <div className="px-3 py-2 text-[12px] text-[var(--text-muted)]">{t('No matches.')}</div>
          )}
          {ranked.map((c, i) => {
            ...
            return (
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="truncate text-[12px] text-[var(--text-primary)]">{c.title}</div>
                  {c.summary && (
        ...
        <div className="border-t border-[var(--panel-border)] px-3 py-1 text-[11px] text-[var(--text-muted)]">
