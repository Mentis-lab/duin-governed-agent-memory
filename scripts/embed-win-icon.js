...
module.exports = async function afterPack(context) {
  ...
  await rcedit(exePath, {
    ...
    'version-string': {
      ProductName: 'DUIN',
      FileDescription: 'DUIN — second-brain agent',
      CompanyName: 'DUIN Contributors',
      LegalCopyright: 'Copyright © 2026 DUIN Contributors. Built on the lamprey UI framework (MIT).'
    },
